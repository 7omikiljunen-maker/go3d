 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Q=function(n,e){if(!n)throw Kr(e)},Kr=function(n){return new Error("Firebase Database ("+M_.SDK_VERSION+") INTERNAL ASSERT FAILED: "+n)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $A{constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}closeAfter(e,t){this.closeAfterResponse=e,this.onClose=t,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,t){for(this.pendingResponses[e]=t;this.pendingResponses[this.currentResponseNum];){const i=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let s=0;s<i.length;++s)i[s]&&Zr(()=>{this.onMessage_(i[s])});if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rl{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){const i=new Oe(kr,e),s=new Oe(kr,t);return this.compare(i,s)!==0}minPost(){return Oe.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let gu;const ur={};class li{static get Default(){return Q(ur&&mt,"ChildrenNode.ts has not been loaded"),gu=gu||new li({".priority":ur},{".priority":mt}),gu}constructor(e,t){this.indexes_=e,this.indexSet_=t}get(e){const t=Or(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof Qt?t:null}hasIndex(e){return Jn(this.indexSet_,e.toString())}addIndex(e,t){Q(e!==Mr,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const i=[];let s=!1;const r=t.getIterator(Oe.Wrap);let o=r.getNext();for(;o;)s=s||e.isDefinedOn(o.node),i.push(o),o=r.getNext();let a;s?a=vc(i,e.getCompare()):a=ur;const c=e.toString(),l={...this.indexSet_};l[c]=e;const u={...this.indexes_};return u[c]=a,new li(u,l)}addToIndexes(e,t){const i=pc(this.indexes_,(s,r)=>{const o=Or(this.indexSet_,r);if(Q(o,"Missing index implementation for "+r),s===ur)if(o.isDefinedOn(e.node)){const a=[],c=t.getIterator(Oe.Wrap);let l=c.getNext();for(;l;)l.name!==e.name&&a.push(l),l=c.getNext();return a.push(e),vc(a,o.getCompare())}else return ur;else{const a=t.get(e.name);let c=s;return a&&(c=c.remove(new Oe(e.name,a))),c.insert(e,e.node)}});return new li(i,this.indexSet_)}removeFromIndexes(e,t){const i=pc(this.indexes_,s=>{if(s===ur)return s;{const r=t.get(e.name);return r?s.remove(new Oe(e.name,r)):s}});return new li(i,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vg(n){return{type:"value",snapshotNode:n}}function Br(n,e){return{type:"child_added",snapshotNode:e,childName:n}}function Lo(n,e){return{type:"child_removed",snapshotNode:e,childName:n}}function No(n,e,t){return{type:"child_changed",snapshotNode:e,childName:n,oldSnap:t}}function FC(n,e){return{type:"child_moved",snapshotNode:e,childName:n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Oh{constructor(e){this.index_=e}updateChild(e,t,i,s,r,o){Q(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const a=e.getImmediateChild(t);return a.getChild(s).equals(i.getChild(s))&&a.isEmpty()===i.isEmpty()||(o!=null&&(i.isEmpty()?e.hasChild(t)?o.trackChildChange(Lo(t,a)):Q(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):a.isEmpty()?o.trackChildChange(Br(t,i)):o.trackChildChange(No(t,i,a))),e.isLeafNode()&&i.isEmpty())?e:e.updateImmediateChild(t,i).withIndex(this.index_)}updateFullNode(e,t,i){return i!=null&&(e.isLeafNode()||e.forEachChild(mt,(s,r)=>{t.hasChild(s)||i.trackChildChange(Lo(s,r))}),t.isLeafNode()||t.forEachChild(mt,(s,r)=>{if(e.hasChild(s)){const o=e.getImmediateChild(s);o.equals(r)||i.trackChildChange(No(s,r,o))}else i.trackChildChange(Br(s,r))})),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?xe.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Sc(){return{value:null,children:new Map}}function Qr(n,e,t){if(Ue(e))n.value=t,n.children.clear();else if(n.value!==null)n.value=n.value.updateChild(e,t);else{const i=De(e);n.children.has(i)||n.children.set(i,Sc());const s=n.children.get(i);e=ot(e),Qr(s,e,t)}}function Yu(n,e){if(Ue(e))return n.value=null,n.children.clear(),!0;if(n.value!==null){if(n.value.isLeafNode())return!1;{const t=n.value;return n.value=null,t.forEachChild(mt,(i,s)=>{Qr(n,new tt(i),s)}),Yu(n,e)}}else if(n.children.size>0){const t=De(e);return e=ot(e),n.children.has(t)&&Yu(n.children.get(t),e)&&n.children.delete(t),n.children.size===0}else return!0}function Ku(n,e,t){n.value!==null?t(e,n.value):HC(n,(i,s)=>{const r=new tt(e.toString()+"/"+i);Ku(s,r,t)})}function HC(n,e){n.children.forEach((t,i)=>{e(i,t)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wp=10*1e3,GC=30*1e3,WC=5*60*1e3;class XC{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new VC(e);const i=Wp+(GC-Wp)*Math.random();yo(this.reportStats_.bind(this),Math.floor(i))}reportStats_(){const e=this.statsListener_.get(),t={};let i=!1;Ut(e,(s,r)=>{r>0&&Jn(this.statsToReport_,s)&&(t[s]=r,i=!0)}),i&&this.server_.reportStats(t),yo(this.reportStats_.bind(this),Math.floor(Math.random()*2*WC))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zr{constructor(e,t,i){this.source=e,this.path=t,this.children=i,this.type=In.MERGE}operationForChild(e){if(Ue(this.path)){const t=this.children.subtree(new tt(e));return t.isEmpty()?null:t.value?new Us(this.source,Ke(),t.value):new zr(this.source,Ke(),t)}else return Q(De(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new zr(this.source,ot(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qC{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function $C(n,e,t,i){const s=[],r=[];return e.forEach(o=>{o.type==="child_changed"&&n.index_.indexedValueChanged(o.oldSnap,o.snapshotNode)&&r.push(FC(o.childName,o.snapshotNode))}),mo(n,s,"child_removed",e,i,t),mo(n,s,"child_added",e,i,t),mo(n,s,"child_moved",r,i,t),mo(n,s,"child_changed",e,i,t),mo(n,s,"value",e,i,t),s}function mo(n,e,t,i,s,r){const o=i.filter(a=>a.type===t);o.sort((a,c)=>KC(n,a,c)),o.forEach(a=>{const c=YC(n,a,r);s.forEach(l=>{l.respondsTo(a.type)&&e.push(l.createEvent(c,n.query_))})})}function YC(n,e,t){return e.type==="value"||e.type==="child_removed"||(e.prevName=t.getPredecessorChildName(e.childName,e.snapshotNode,n.index_)),e}function KC(n,e,t){if(e.childName==null||t.childName==null)throw Kr("Should only compare child_ events.");const i=new Oe(e.childName,e.snapshotNode),s=new Oe(t.childName,t.snapshotNode);return n.index_.compare(i,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ol(n,e){return{eventCache:n,serverCache:e}}function So(n,e,t,i){return ol(new Qi(e,t,i),n.serverCache)}function yg(n,e,t,i){return ol(n.eventCache,new Qi(e,t,i))}function Ec(n){return n.eventCache.isFullyInitialized()?n.eventCache.getNode():null}function Os(n){return n.serverCache.isFullyInitialized()?n.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ac;function LR(n){Q(!Ac,"__referenceConstructor has already been defined"),Ac=n}function NR(){return Q(Ac,"Reference.ts has not been loaded"),Ac}let DR=1;class Qp{constructor(e){this.listenProvider_=e,this.syncPointTree_=new ct(null),this.pendingWriteTree_=lR(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Ng(n,e,t,i,s){return JC(n.pendingWriteTree_,e,t,i,s),s?eo(n,new Us(kh(),e,t)):[]}function UR(n,e,t,i){ZC(n.pendingWriteTree_,e,t,i);const s=ct.fromObject(t);return eo(n,new zr(kh(),e,s))}function Ui(n,e,t=!1){const i=QC(n.pendingWriteTree_,e);if(eR(n.pendingWriteTree_,e)){let r=new ct(null);return i.snap!=null?r=r.set(Ke(),!0):Ut(i.children,o=>{r=r.set(new tt(o),!0)}),eo(n,new xc(i.path,r,t))}else return[]}function Jo(n,e,t){return eo(n,new Us(Bh(),e,t))}function OR(n,e,t){const i=ct.fromObject(t);return eo(n,new zr(Bh(),e,i))}function FR(n,e){return eo(n,new Uo(Bh(),e))}function kR(n,e,t){const i=qh(n,t);if(i){const s=$h(i),r=s.path,o=s.queryId,a=qt(r,e),c=new Uo(zh(o),a);return Yh(n,r,c)}else return[]}function Cc(n,e,t,i,s=!1){const r=e._path,o=n.syncPointTree_.get(r);let a=[];if(o&&(e._queryIdentifier==="default"||Lg(o,e))){const c=PR(o,e,t,i);RR(o)&&(n.syncPointTree_=n.syncPointTree_.remove(r));const l=c.removed;if(a=c.events,!s){const u=l.findIndex(d=>d._queryParams.loadsAllData())!==-1,h=n.syncPointTree_.findOnPath(r,(d,p)=>es(p));if(u&&!h){const d=n.syncPointTree_.subtree(r);if(!d.isEmpty()){const p=HR(d);for(let _=0;_<p.length;++_){const g=p[_],m=g.query,f=Fg(n,g);n.listenProvider_.startListening(Eo(m),Oo(n,m),f.hashFn,f.onComplete)}}}!h&&l.length>0&&!i&&(u?n.listenProvider_.stopListening(Eo(e),null):l.forEach(d=>{const p=n.queryToTagMap.get(ll(d));n.listenProvider_.stopListening(Eo(d),p)}))}VR(n,l)}return a}function Dg(n,e,t,i){const s=qh(n,i);if(s!=null){const r=$h(s),o=r.path,a=r.queryId,c=qt(o,e),l=new Us(zh(a),c,t);return Yh(n,o,l)}else return[]}function BR(n,e,t,i){const s=qh(n,i);if(s){const r=$h(s),o=r.path,a=r.queryId,c=qt(o,e),l=ct.fromObject(t),u=new zr(zh(a),c,l);return Yh(n,o,u)}else return[]}function th(n,e,t,i=!1){const s=e._path;let r=null,o=!1;n.syncPointTree_.foreachOnPath(s,(d,p)=>{const _=qt(d,s);r=r||Gi(p,_),o=o||es(p)});let a=n.syncPointTree_.get(s);a?(o=o||es(a),r=r||Gi(a,Ke())):(a=new Cg,n.syncPointTree_=n.syncPointTree_.set(s,a));let c;r!=null?c=!0:(c=!1,r=xe.EMPTY_NODE,n.syncPointTree_.subtree(s).foreachChild((p,_)=>{const g=Gi(_,Ke());g&&(r=r.updateImmediateChild(p,g))}));const l=Lg(a,e);if(!l&&!e._queryParams.loadsAllData()){const d=ll(e);Q(!n.queryToTagMap.has(d),"View does not exist, but we have a tag");const p=GR();n.queryToTagMap.set(d,p),n.tagToQueryMap.set(p,d)}const u=al(n.pendingWriteTree_,s);let h=IR(a,e,t,u,r,c);if(!l&&!o&&!i){const d=Pg(a,e);h=h.concat(WR(n,e,d))}return h}function Xh(n,e,t){const s=n.pendingWriteTree_,r=n.syncPointTree_.findOnPath(e,(o,a)=>{const c=qt(o,e),l=Gi(a,c);if(l)return l});return Eg(s,e,r,t,!0)}function zR(n,e){const t=e._path;let i=null;n.syncPointTree_.foreachOnPath(t,(l,u)=>{const h=qt(l,t);i=i||Gi(u,h)});let s=n.syncPointTree_.get(t);s?i=i||Gi(s,Ke()):(s=new Cg,n.syncPointTree_=n.syncPointTree_.set(t,s));const r=i!=null,o=r?new Qi(i,!0,!1):null,a=al(n.pendingWriteTree_,e._path),c=Rg(s,e,a,r?o.getNode():xe.EMPTY_NODE,r);return MR(c)}function eo(n,e){return Ug(e,n.syncPointTree_,null,al(n.pendingWriteTree_,Ke()))}function Ug(n,e,t,i){if(Ue(n.path))return Og(n,e,t,i);{const s=e.get(Ke());t==null&&s!=null&&(t=Gi(s,Ke()));let r=[];const o=De(n.path),a=n.operationForChild(o),c=e.children.get(o);if(c&&a){const l=t?t.getImmediateChild(o):null,u=Mg(i,o);r=r.concat(Ug(a,c,l,u))}return s&&(r=r.concat(Wh(s,n,i,t))),r}}function Og(n,e,t,i){const s=e.get(Ke());t==null&&s!=null&&(t=Gi(s,Ke()));let r=[];return e.children.inorderTraversal((o,a)=>{const c=t?t.getImmediateChild(o):null,l=Mg(i,o),u=n.operationForChild(o);u&&(r=r.concat(Og(u,a,c,l)))}),s&&(r=r.concat(Wh(s,n,i,t))),r}function Fg(n,e){const t=e.query,i=Oo(n,t);return{hashFn:()=>(ER(e)||xe.EMPTY_NODE).hash(),onComplete:s=>{if(s==="ok")return i?kR(n,t._path,i):FR(n,t._path);{const r=FA(s,t);return Cc(n,t,null,r)}}}}function Oo(n,e){const t=ll(e);return n.queryToTagMap.get(t)}function ll(n){return n._path.toString()+"$"+n._queryIdentifier}function qh(n,e){return n.tagToQueryMap.get(e)}function $h(n){const e=n.indexOf("$");return Q(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new tt(n.substr(0,e))}}function Yh(n,e,t){const i=n.syncPointTree_.get(e);Q(i,"Missing sync point for query tag that we're tracking");const s=al(n.pendingWriteTree_,e);return Wh(i,t,s,null)}function HR(n){return n.fold((e,t,i)=>{if(t&&es(t))return[cl(t)];{let s=[];return t&&(s=Ig(t)),Ut(i,(r,o)=>{s=s.concat(o)}),s}})}function Eo(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(NR())(n._repo,n._path):n}function VR(n,e){for(let t=0;t<e.length;++t){const i=e[t];if(!i._queryParams.loadsAllData()){const s=ll(i),r=n.queryToTagMap.get(s);n.queryToTagMap.delete(s),n.tagToQueryMap.delete(r)}}}function GR(){return DR++}function WR(n,e,t){const i=e._path,s=Oo(n,e),r=Fg(n,t),o=n.listenProvider_.startListening(Eo(e),s,r.hashFn,r.onComplete),a=n.syncPointTree_.subtree(i);if(s)Q(!es(a.value),"If we're adding a query, it shouldn't be shadowed");else{const c=a.fold((l,u,h)=>{if(!Ue(l)&&u&&es(u))return[cl(u).query];{let d=[];return u&&(d=d.concat(Ig(u).map(p=>p.query))),Ut(h,(p,_)=>{d=d.concat(_)}),d}});for(let l=0;l<c.length;++l){const u=c[l];n.listenProvider_.stopListening(Eo(u),Oo(n,u))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sI{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function dl(n,e){let t=null;for(let i=0;i<e.length;i++){const s=e[i],r=s.getPath();t!==null&&!Nh(r,t.path)&&(n.eventLists_.push(t),t=null),t===null&&(t={events:[],path:r}),t.events.push(s)}t&&n.eventLists_.push(t)}function $g(n,e,t){dl(n,t),Yg(n,i=>Nh(i,e))}function xn(n,e,t){dl(n,t),Yg(n,i=>vn(i,e)||vn(e,i))}function Yg(n,e){n.recursionDepth_++;let t=!0;for(let i=0;i<n.eventLists_.length;i++){const s=n.eventLists_[i];if(s){const r=s.path;e(r)?(rI(n.eventLists_[i]),n.eventLists_[i]=null):t=!1}}t&&(n.eventLists_=[]),n.recursionDepth_--}function rI(n){for(let e=0;e<n.events.length;e++){const t=n.events[e];if(t!==null){n.events[e]=null;const i=t.getEventRunner();vo&&Nt("event: "+t.toString()),Zr(i)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rd{constructor(e,t,i,s){this._repo=e,this._path=t,this._queryParams=i,this._orderByCalled=s}get key(){return Ue(this._path)?null:Lh(this._path)}get ref(){return new Zn(this._repo,this._path)}get _queryIdentifier(){const e=Gp(this._queryParams),t=Ch(e);return t==="{}"?"default":t}get _queryObject(){return Gp(this._queryParams)}isEqual(e){if(e=At(e),!(e instanceof rd))return!1;const t=this._repo===e._repo,i=Nh(this._path,e._path),s=this._queryIdentifier===e._queryIdentifier;return t&&i&&s}toJSON(){return this.toString()}toString(){return this._repo.toString()+mC(this._path)}}class Zn extends rd{constructor(e,t){super(e,t,new Fh,!1)}get parent(){const e=hg(this._path);return e===null?null:new Zn(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class Gr{constructor(e,t,i){this._node=e,this.ref=t,this._index=i}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new tt(e),i=Wr(this.ref,e);return new Gr(this._node.getChild(t),i,mt)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(i,s)=>e(new Gr(s,Wr(this.ref,i),mt)))}hasChild(e){const t=new tt(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function Wi(n,e){return n=At(n),n._checkNotDeleted("ref"),e!==void 0?Wr(n._root,e):n._root}function Wr(n,e){return n=At(n),De(n._path)===null?nI("child","path",e):qg("child","path",e),new Zn(n._repo,pt(n._path,e))}function iv(n){return n=At(n),new AI(n._repo,n._path)}function CI(n,e){n=At(n),fr("push",n._path),Rc("push",e,n._path,!0);const t=Kg(n._repo),i=bI(t),s=Wr(n,i),r=Wr(n,i);let o;return e!=null?o=sv(r,e).then(()=>r):o=Promise.resolve(r),s.then=o.then.bind(o),s.catch=o.then.bind(o,void 0),s}function sv(n,e){n=At(n),fr("set",n._path),Rc("set",e,n._path,!1);const t=new Gn;return dI(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}function ea(n,e){Xg("update",e,n._path);const t=new Gn;return fI(n._repo,n._path,e,t.wrapCallback(()=>{})),t.promise}function rv(n){n=At(n);const e=new nv(()=>{}),t=new ml(e);return hI(n._repo,n,t).then(i=>new Gr(i,new Zn(n._repo,n._path),n._queryParams.getIndex()))}class ml{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const i=t._queryParams.getIndex();return new ev("value",this,new Gr(e.snapshotNode,new Zn(t._repo,t._path),i))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new tv(this,e,t):null}matches(e){return e instanceof ml?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}class od{constructor(e,t){this.eventType=e,this.callbackContext=t}respondsTo(e){let t=e==="children_added"?"child_added":e;return t=t==="children_removed"?"child_removed":t,this.eventType===t}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new tv(this,e,t):null}createEvent(e,t){Q(e.childName!=null,"Child events should have a childName.");const i=Wr(new Zn(t._repo,t._path),e.childName),s=t._queryParams.getIndex();return new ev(e.type,this,new Gr(e.snapshotNode,i,s),e.prevName)}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof od?this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)):!1}hasAnyCallback(){return!!this.callbackContext}}function ov(n,e,t,i,s){const r=new nv(t,void 0),o=e==="value"?new ml(r):new od(e,r);return vI(n._repo,n,o),()=>yI(n._repo,n,o)}function av(n,e,t,i){return ov(n,"value",e)}function RI(n,e,t,i){return ov(n,"child_added",e)}AR(Zn);LR(Zn);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function BI(n){bA(Jr),Yn(new Dn("database",(e,{instanceIdentifier:t})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return NI(i,s,r,t)},"PUBLIC").setMultipleInstances(!0)),yn(bp,Ap,n),yn(bp,Ap,"esm2020")}pi.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};pi.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};BI();const cv="@firebase/installations",ad="0.6.22";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Lc=new il("@firebase/auth");function c1(n,...e){Lc.logLevel<=rt.WARN&&Lc.warn(`Auth (${Jr}): ${n}`,...e)}function Ha(n,...e){Lc.logLevel<=rt.ERROR&&Lc.error(`Auth (${Jr}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function g1(n,e){return no(n,"POST","/v1/accounts:delete",e)}async function Nc(n,e){return no(n,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xv(n,e=[]){let t;switch(n){case"Browser":t=vm(jt());break;case"Worker":t=`${vm(jt())}-${n}`;break;default:t=n}const i=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${Jr}/${i}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function C1(n,e={}){return no(n,"GET","/v2/passwordPolicy",_d(n,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xr{constructor(e){this.user=e.user,this.providerId=e.providerId,this._tokenResponse=e._tokenResponse,this.operationType=e.operationType}static async _fromIdTokenResponse(e,t,i,s=!1){const r=await Pn._fromIdTokenResponse(e,i,s),o=xm(i);return new Xr({user:r,providerId:o,_tokenResponse:i,operationType:t})}static async _forOperation(e,t,i){await e._updateTokensIfNecessary(i,!0);const s=xm(i);return new Xr({user:e,providerId:s,_tokenResponse:i,operationType:t})}}function xm(n){return n.providerId?n.providerId:"phoneNumber"in n?"phone":null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tm(n,e,t){return SL(n,e,t)}async function SL(n,e,t){if(_n(n.app))return Promise.reject(Xi(n));const i=io(n);Pv(n,e,vl),await i._initializationPromise;const s=xd(i,t);return await vL(s,i),s._openRedirect(i,e,"signInViaRedirect")}async function xL(n,e){return await io(n)._initializationPromise,oy(n,e,!1)}async function oy(n,e,t=!1){if(_n(n.app))return Promise.reject(Xi(n));const i=io(n),s=xd(i,e),o=await new _L(i,s,t).execute();return o&&!t&&(delete o.user._redirectEventId,await i._persistUserIfCurrent(o.user),await i._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function wL(n,e={}){return no(n,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
